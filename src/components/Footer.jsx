...
const Footer = ({theme}) => {
  return (
    ...
    sm:px-10 lg:px-24 xl:px-40 text-gray-700 dark:text-gray-300'>
        ...
        transition={{duration:0.6, delay:0.2}}
         viewport={{once:true}}
            className='space-y-5 text-sm text-gray-700 dark:text-gray-400'>
                ...
                <p className='max-w-md'>We design, build, and optimize digital solutions that create real impact.</p>
            ...
            <ul className='flex gap-8'>
                ...
                className='text-gray-600 dark:text-gray-400'>
                    <h3 className='font-sm mt-2 mb-6'>Subscribe to our newsletter</h3>
                    <p className='text-sm mt-2 mb-6'>Never miss out—get the latest resources and updates in your inbox every week.</p>
        ...
        <hr className='border-gray-300 dark:border-gray-600 my-6'/>
            ...
            justify-center sm:justify-between gap-4 flex-wrap'>
                <p>Copyright 2025 © Created by Maheshwari. </p>
                <div className='flex items-ctner justify-between gap-4'>
