...
const onSubmit = async (event) => {
    ...
    formData.append("access_key", "6caf1e57-3847-4249-9fc4-a11fc3486d3d");
  ...
  return (
    ...
    lg:px-24 xl:px-40 pt-30 text-gray-700 dark:text-white' >
        <Title title='Reach out to us' desc='Crafting innovative solutions that accelerate your path to success.'/>
        <motion.form 
        ...
        onSubmit={onSubmit} className='grid sm:grid-cols-2 gap-3 sm:gap-5 max-w-2xl w-full'>
            ...
            <button type="submit" className='w-max flex gap-2 bg-blue-600 text-white text-sm px-10 py-3
